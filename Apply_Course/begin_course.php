...
if(!isset($_GET['s']))
{
	if($_SESSION['values']['attribute'] != 2) // 即已經做了選擇了
	{
		...
		$_SESSION['values']['teacher']					= $_POST['teacher'];
		// modify by Samuel @ 2010/03/16 
    ...
    */
    ...
    $tpl->assign("teacher",$_SESSION['values']['teacher']);
	$tpl->assign("teacherFailed",$_SESSION['errors']['teacher']);		
	...
	//輸出頁面
	assignTemplate($tpl, "/apply_course/begin_course.tpl");	
