...
function genUpdateSQL(& $nknu_table, & $the_course)
{
    ...
    $sql_update_teacher_list = " update course set TeacherList = '{$teacherList}',CourseState = 1,CourseError = 1,EndTime='".date('Y/m/s 00:00:00')."' where Import_ID = {$begin_course_cd} ;";
