...
check_access("verify_passed_course_list") ;
...
$sql = "SELECT 
	...
	AND bc.begin_coursestate ='1' 
	AND $list_category_sql
	ORDER BY bc.begin_course_cd desc ";
...
assignTemplate($tpl, '/apply_course/verify_passed_course_list.tpl');
