...
<tr>
	...
	<input id="begin_course_name" name="begin_course_name" type="text" value="{$ValueOfBegin_course_name}" onblur="validate(this.value, this.id);">
		...
		<span id="begin_course_nameFailed" class="{$begin_course_nameFailed}"></span>	
	</td>
</tr>	
<tr>
	<td>開課單位</td>
...
<tr>
	<td>對應內部課程號</td>
	<td>
	<input id="inner_course_cd" name="inner_course_cd" type="text" value="{$ValueOfInner_course_cd}"></td>
...
<tr>
	<td>開課所屬的學年</td>
	<td>
	<input id="course_year" name="course_year" type="text" value="{$ValueOfCourse_year}"></td>
...
<tr>
	<td>開課所屬的學期</td>
	<td>
	<input id="course_session" name="course_session" type="text" value="{$ValueOfCourse_session}"></td>
