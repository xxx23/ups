...
//update_status ( "確認開課中" );
    ...
    //add by aeil, ref Personal_Page/courseList.php
	...
	if($_GET['action'] == "modify"){
		...
		{
            $days = "";
            $days = ($_POST['d_course_begin'] == 'undefined')?""
				:"d_course_begin='".$_POST['d_course_begin']."',";
            $days .= ($_POST['d_course_end'] == 'undefined')?""
				:"d_course_end='".$_POST['d_course_end']."',";
            $days .= ($_POST['d_public_day'] == 'undefined')?""
				:"d_public_day='".$_POST['d_public_day']."',";
            $days .= ($_POST['d_select_begin'] == 'undefined')?""
				:"d_select_begin='".$_POST['d_select_begin']."',";
            $days .= ($_POST['d_select_end'] == 'undefined')?""
	...
	//輸出頁面
	assignTemplate($tpl, "/course_admin/view_course.tpl");	
