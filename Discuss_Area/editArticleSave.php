<?
    ...
    //die($discuss_title . "=================" . $content_body);

    $sql = "update discuss_subject set discuss_title='$discuss_title' 
        where begin_course_cd=$begin_course_cd and discuss_cd=$discuss_cd and discuss_content_cd=$discuss_content_cd";
    //die($sql);
    $res = db_query($sql);

    $sql = "update discuss_content set discuss_title='$discuss_title', content_body='$content_body' 
        where begin_course_cd=$begin_course_cd and discuss_cd=$discuss_cd and discuss_content_cd=$discuss_content_cd and reply_content_cd=1";
    $res = db_query($sql);
    ...
    header("Location: groupShowArticleList.php?behavior=$behavior&type=$type");
