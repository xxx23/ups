...
//	$templateNumber = 2 ; 
	...
	if($isShowSmartyTemplate == 1)
	{
		...
		{
			case 1:		assignTemplate($tpl, "/discuss_area/articleList.tpl");		break;
			case 2:		assignTemplate($tpl, "/discuss_area/articleList_bbs.tpl");	break;			
			default:	assignTemplate($tpl, "/discuss_area/articleList.tpl");		break;
		}
	}
?>
