...
*/
	...
	//搜尋所有系統的公告
	$res = $DB_CONN->query("SELECT A.* FROM news A, news_target B WHERE B.begin_course_cd = $begin_course_cd AND B.news_cd = A.news_cd ORDER BY A.d_news_begin DESC, A.news_cd DESC");
	...
	$rss = new rss_generator("E-Learning Course Announcement");
	$rss->__set("encoding", "UTF-8");
	$rss->__set("title", "E-Learning Course Announcement");
	$rss->__set("language", "zh");
	$rss->__set("description", "E-Learning Course Announcement");
