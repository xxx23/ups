...
$absoluteURL = $HOMEURL . "System_News/";
	...
	//搜尋所有系統的公告
	$res = db_query("SELECT A.* FROM news A, news_target B WHERE B.role_cd = 0 AND A.news_cd = B.news_cd ORDER BY A.d_news_begin DESC, A.news_cd DESC");
	...
	if($newsNum > 0)
	{
		...
		while ($res->fetchInto($row, DB_FETCHMODE_ASSOC) )
		{
			...
			$link = "systemNews_show_rss.php?argument=" . $news_cd . "_";
