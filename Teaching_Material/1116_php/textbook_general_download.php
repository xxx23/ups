...
//echo $sql;
	...
	//------------------------------------------------------------------------------------	add by joyce 1108(3種下載)
	function getDownlink($Content_cd , $type)
	{
		if($type == "rar"){
			$row = "<a href='download_reason.php?share=1&content_cd=".$Content_cd."&d_type=0><img src=\"".createTPLPath()."/images/icon/download.gif\"></a>";
			$row .= "<a href='download_reason.php?share=1&content_cd=".$Content_cd."&d_type=1><img src=\"".createTPLPath()."/images/icon/download.gif\"></a>";
			$row .= "<a href='download_reason.php?share=1&content_cd=".$Content_cd."&d_type=2><img src=\"".createTPLPath()."/images/icon/download.gif\"></a>";
		}
		else
			$row = "<a href='download_reason.php?share=1&content_cd=".$Content_cd."&d_type=3><img src=\"".createTPLPath()."/images/icon/download.gif\"></a>";
		return $row;
	}
...
//------------------------------------------------------------------------------------	add by joyce
	...
	function getContent_info($packet_type,$license)
	{
		switch($packet_type)
		{
			/*==================packet_type:0-2 要改為3種都提供=======================*/
			case 0:
            case 1:
            case 2:
				$row['packet_type'] = "rar";
			break;
			/*==================packet_type:3-4 先和原先一樣=======================*/
            case 3:
            case 4: 
				$row['packet_type'] = "zip";
			break;
