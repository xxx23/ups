<?php
/********************************************************/
/* id: personal_tracking.php 2007/9/7 by hushpuppy Exp. */
/* function: 傳入personal_id 輸出個人教材瀏覽狀況樹狀圖	*/
/********************************************************/
...
$AddNode = buildTreeStructure($Content_cd, $Personal_id, $Begin_course_cd);
//print $AddNode;
...
assignTemplate($smtpl,"/teaching_material/personal_tracking.tpl");
...
function buildTreeStructure($Content_cd, $Personal_id, $Begin_course_cd) {
	...
	$status_str = learning_status_str($row['menu_id'], $Personal_id, $Begin_course_cd);
