...
$personal_id=$_SESSION['personal_id'];
    ...
    $delayseconds = 2;  // Delay time before sco launch, used to give time to browser to define 
    ...
    if ($sco->scormtype == 'asset') {
       $attempt = scorm_get_last_attempt($scorm->id,$personal_id);
       $element = ($scorm->version == 'scorm_13' || $scorm->version == 'SCORM_1.3') ?'cmi.completion_status':'cmi.core.lesson_status';
       $value = 'completed';
       $result = scorm_insert_track($personal_id, $scorm->id, $sco->id, $attempt, $element, $value);
    }
