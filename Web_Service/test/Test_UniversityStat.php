...
//連線到ups的webservice
$client = new SoapClient('http://ups.moe.edu.tw/Web_Service/api.php?wsdl&service=UniversityStat' ,array('cache_wsdl' => WSDL_CACHE_NONE));
$client->__setSoapHeaders(array($header));

try
{
   //讀取資料
   $datas = $client->getStudentData('','');
   $header = array('姓名','學校','課程名稱','課程類別','通過與否','通過時間');
