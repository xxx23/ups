...
//Web Server Setting
	...
	$WEBROOT = "/~phina/";
	$HOME_PATH = "/home/phina/WWW/";

//database setting
	$DB_TYPE = "mysql";
	$DB_HOST = "localhost";
	$DB_NAME = "edu_eleanidx";
    $DB_USERNAME = "edu_eleanidx";
    $DB_USERPASSWORD = "edu_eleanidx";
...
//MAIL settings
    ...
    set_include_path( get_include_path() . PATH_SEPARATOR . $HOME_PATH.$LIBRARY_PATH."Smarty". PATH_SEPARATOR . $HOME_PATH.$LIBRARY_PATH."PearDB". PATH_SEPARATOR . $HOME_PATH );
	//Pear DB library
	require_once("DB.php");
