	...
	*/
	...
	var Facebox = function(_options) {		
		...
		this.show = function() {
            ...
            //link:'chain',
              ...
              //alert(this.response.text);
							options.message = this.response.text; 
						},
      ...
      //alert(content);
      if(options.url.search(/validated/) != -1)
      {
        /*
      ...
      //alert(options.url.search(/validated/));
      //document.getElementsByTagName("script")[0].appendChild(mootoolfb);
      //mootoolfb = '<script type="text/javascript" src="'
      //    + "../script/TextboxList/mootools-1.2.4-core.js" + '"></scr' + 'ipt>'
