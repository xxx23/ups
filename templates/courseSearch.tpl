...
<h1>課程總覽</h1>
<div class="describe"> 可透過課程狀態來進行搜尋，或選擇課程屬性搜尋課程，亦可直接輸入課程名稱進行搜尋；欲觀看有對外公開之課程內容，請按左上方訪客進入，此處僅供查詢課程名稱。</div>
...
<table style="width:90%" class="datatable">
    ...
    {if $role_cd eq 3}<td style="text-align:center;"><a target="_blank" href="../Course/std_course_intro2.php?begin_course_cd={$course.begin_course_cd}">選課<br/>須知</></td>{/if}
