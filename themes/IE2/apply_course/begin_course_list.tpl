...
<form action="delete_course.php" method="POST" name="delete_course">
  <table class="datatable" style="width:95%">
    <tr>
      ...
      <th width="10%"> <div align="center">課程性質</div></th>
...
{*	  <!-- th width="5%"> <div align="center">證書</div></th --> *}
      ...
      <th width="12%"> <div align="center">審核狀態</div></th>
...
{*<td> <div align="center"><a href="../Certificate/certificateManagement.php?begin_course_cd={$course.begin_course_cd}&incomingPage=../Course_Admin/show_all_begin_course.php" >設定</a></div></td> *}
      <td><div align="center"><a href="./add_teacher_to_course.php?begin_course_cd={$course.begin_course_cd}" ><img src="{$tpl_path}/images/apply_course/30.gif" alt="修改" border="0px"></a></div></td>	  
      <td><div align="center"><a href="./view_course.php?begin_course_cd={$course.begin_course_cd}" ><img src="{$tpl_path}/images/apply_course/30.gif" alt="修改" border="0px"></a>&nbsp;</div></td>
      <td><div align="center">{$course.course_state}</div></td>
    </tr>
	{/foreach}
  </table>
