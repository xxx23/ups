...
{literal}		
        ...
        $(function(){
            ...
            function update_course() { 
                ...
                var date_course_begin = ''; //$('#date_course_begin').val(); //略過課程時間
...
<form id="query" action="stat_request1.php" method="GET">
...
<div style="text-align:center; margin-left:50px;">
	<input type="button" onclick="javascript:location.href='stat_request1.php?dl_excel=1&{$url_param}'" value="搜尋結果下載存為EXCEL">
</div>
{/if}
...
{if !empty($data)}
	...
	<tr>
		...
		{else}
			...
			<td style="width:200px"><a target="_blank" href="stat_request1.php?{$row.url_query_course}" title="觀看此課程狀態">{$row.begin_course_name}</a></td>
