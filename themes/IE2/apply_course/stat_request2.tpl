...
<form id="query" action="stat_request2.php" method="GET">
...
<br/>
       ...
       <div id="orderby">
            ...
            {if $session_no == 13}
            <label>國民中小學教師九門課程依縣市排序：</label><input name="order_method" id="order_teacher" type="radio" value="3" {if $order_method ==3}checked="checked"{/if}/>
            {/if}
            </div>
       </div>
...
<div style="text-align:center; margin-left:50px;">
	<input type="button" onclick="javascript:location.href='stat_request2.php?dl_excel=1&{$url_param}'" value="搜尋結果下載存為EXCEL">
</div>
{/if}
