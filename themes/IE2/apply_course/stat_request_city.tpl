...
<div id="cond" style="text-align:left; clear:both;">
        ...
        <div id="class_kind_div">
            <p align="left">
                ...
                符合課程條件課程:<select name="class_choose" id="class_choose">
                     <option value="-1" >不限</option>
...
<p style="text-align:center; width:93%;">
	{#total_pass_total_people#}&nbsp;&nbsp;&nbsp;{$total_stu_pass}/{$total_stu} , 總通過時數: {$total_stu_pass_certify_hour} 小時
</p>
...
<table class =" datatable" id ="course_stat">
    <thead>
        <tr>
            <th colspan="4">課程統計 <button id="course_stat_btn">展開/收合</button></th>
        </tr>
