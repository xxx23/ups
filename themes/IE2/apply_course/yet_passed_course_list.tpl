...
<tr>
	...
	<th style="width:15%; text-align:center">開課屬性</th>
...
{foreachelse}
	...
	<td colspan="6" style="text-align:center;"><img src="{$tpl_path}/images/apply_course/icon3.png" style="border:dashed 1px #ccc;background:#eee;">目前沒有課程。
