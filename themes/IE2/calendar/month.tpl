...
<input class="btn" type="submit" name="submitButton" onclick="if(checkEmpty()) return false;" value="Go!" />	</p>					
</form>
{/if}
<br />
<br />
...
<div id="note_edit" style="display:none;position:absolute;width:30%;height:10%; background-color:#FFFFFF; z-index:100;">
	<div style="cursor:move;width:100%;height:20px; text-align:center; border:1px solid #CCCCCC;"  onmousedown="init();"  >{$personal_name}的行事曆</div>
...
<div id="new_note_edit" style="display:none;position:absolute;width:30%;height:10%; background-color:#FFFFFF;">
	<div style="cursor:move;width:100%;height:20px; border: 1px solid #CCCCCC;"  onmousedown="init();"  >{$personal_name}的行事曆</div>
	<table class="datatable">
	  <tr class="tr2">
		<td>日期</td>
		<td>&nbsp;</td>
