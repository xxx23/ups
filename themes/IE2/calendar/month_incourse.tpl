...
<body class="ifr" onmousemove="moveit();" onmouseup="stopdrag();">
<p class="intro">
說明：<br />
按<span class="imp">日期</span>可以<strong>新增筆記</strong>。 <br />
...
<input class="btn" type="button" value="今天" />
...
<input class="btn" type="submit" name="submitButton" value="Go!" />						
</form>
</caption>
<br />
<br />
...
<br />
<!--修改模式 -->
<div id="note_edit" style="display:none;position:absolute;width:30%;height:10%;">
	<div class="datatable" style="cursor:move;width:100%;height:100%;"  onmousedown="init();"  >{$personal_name}的行事曆</div>
...
<!-- edit note-->
<div id="new_note_edit" style="display:none;position:absolute;width:30%;height:10%;">
	<div class="datatable" style="cursor:move;width:100%;height:100%;"  onmousedown="init();"  >{$personal_name}的行事曆</div>
	<table class="datatable">
	  <tr class="tr2">
		<td>日期</td>
