...
<div class="searchbar" style="width:80%;margin:auto auto;">
   ...
   <!--div class="searchlist" style="margin:auto auto">
        <div class="button001">
        <a href="nknu_mgm.php?action=resend_old">(舊資料)傳送認證</a>
        </div>
    </div-->
  
    <div class="searchlist" style="margin:auto auto">
        <div class="button001">
        <a target="_blank"href="https://formal.inservice.edu.tw/">資訊傳報系統</a> 
        </div>
    </div>
    <div class="describe">
    <ol>
...
<!-- SENDED VERIFY CHECK-->
<div id="tab3">
	<iframe id="certify_check"  style="border:none;" frameborder="no" src="CheckCertifySend.php" scrolling="no" width="100%" height="500"></iframe> 
</div>
<!-- RESEND -->
