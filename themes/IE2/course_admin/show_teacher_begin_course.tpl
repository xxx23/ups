...
<table class="datatable">
	<tr>
		<th>課程編號</th><th>開課單位</th><th>開課名稱</th><th>授課教師</th><th>開課確認</th>
	</tr>
	...
	<tr>
		...
		<td><input class="btn" type="button" name="checkButton" value="確認" onClick="checkBeginCourse({$course.course_cd}, {$course.begin_course_cd});"></td>
	</tr>	
	{/foreach}
</table>
<br />
