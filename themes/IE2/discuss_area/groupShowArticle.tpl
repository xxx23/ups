...
<div class="al-left">
<a href="newArticle.php?behavior={$behavior}&action=new"> <img src="{$tpl_path}/images/icon/article_new.gif" alt="發表新文章" /></a> 
<a href="newArticle.php?behavior={$behavior}&action=reply&reply_content_cd={$replyList[$currentReplyArrayNumber].reply_content_cd}"> <img src="{$tpl_path}/images/icon/article_reply.gif" alt="回覆文章" /></a> 
