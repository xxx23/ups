...
<center>
	  ...
	  <table border="0" align="right" cellpadding="0" cellspacing="0" style="font-size:14px;">
        <tr>
          <td width="90" height="27" ><div class="button001" align="center"><a href="new_teacher.php">新增教師</a></div></td>
        <td width="90" height="27" ><div class="button001" align="center"><a href="check_teacher.php?option=view">審核教師</a> </div></td>
        </tr>
      </table>
</center>
  <hr width="100%" style="color: #fff; background-color: #fff; border: 1px dotted #6699FF; border-style: none none dotted;">
	...
	<div align="right"></div>
	<form method="post" action="./list_teacher.php?action=search">
...
<hr width="100%" style="color: #fff; background-color: #fff; border: 1px dotted #6699FF; border-style: none none dotted;">
	...
	<table class="datatable" style="margin-left:50px"><tbody>
