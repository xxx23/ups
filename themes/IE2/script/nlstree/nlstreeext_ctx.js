/**
** nlstreeext_ctx.js v2.2
** NLSTree Professional Extension for Standard Context Menu Operation
** This file is property of www.addobject.com
...
/*NLSTREE.ctx_liveAdd = function (prId) {
  ...
  xmlHttp.open("GET","/Teaching_Material/return_id.php",false); //等待server傳回給node_id後，才往下執行
  xmlHttp.onReadyStateChange = callBack;
  xmlHttp.send(null); 
  
  url = "textbook_content.php?content_cd="+content_cd+"&menu_id="+node_id;
