...
<table style="width:90%" class="datatable">
  ...
  {foreach item=course from=$courseList} 
	<tr>
        ...
        {else}
            <a href='download_reason.php?share=1&content_cd={$course.content_cd}&d_type=5' ><img src="{$webroot}images/down_tpye/0.gif"></a>&nbsp;
            <a href='download_reason.php?share=1&content_cd={$course.content_cd}&d_type=3' ><img src="{$webroot}images/down_tpye/1.gif"></a>&nbsp;
            <a href='download_reason.php?share=1&content_cd={$course.content_cd}&d_type=4' ><img src="{$webroot}images/down_tpye/2.gif"></a>&nbsp;
        {/if} 
        </td>
	</tr>
  {/foreach} 
