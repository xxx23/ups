...
<div id="contents" width="400" height="300">
	<div id="nav" style="float:left;width:20%;height:100%;">
   	    <div class="area_title" id ="message_title">
        <font size="3">*請先點選下列章節名稱，然後填寫表格</font></div>
		<div class="area" id="message"><script>tree.render();</script></div>
    </div>
	<div id="content" style="float:left;height:800;width:500px;">
		<iframe id="textbook" name="textbook" frameborder="0" width="500" height="800" src="textbook_error_report_2.php?content_cd={$Content_cd}"></iframe>
	</div>
</div>
